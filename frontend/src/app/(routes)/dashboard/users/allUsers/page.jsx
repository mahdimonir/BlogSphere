...
export default async function UserManagement({ searchParams }) {
  ...
  return (
    <div className="flex w-full min-h-full flex-col  bg-red-500">
      {/* Table Section */}
      <div className="p-5 w-full min-w-[18rem] overflow-x-auto bg-white   shadow-lg">
        <div className="flex gap-3 items-center mb-4">
          <h1 className="text-md font-bold">All users</h1>
          <DashBoardSearch
            api="/dashboard/users"
