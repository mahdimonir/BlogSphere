  ...
  return (
    <div className="w-full min-h-screen flex flex-col gap-3 p-3">
      ...
      <div className="flex gap-4 items-center">
        <div className="w-[100px] h-[100px] bg-gray-400 flex items-center text-white justify-center rounded-full"> Photo</div>
        <div>
          <p><strong>Name:</strong> {user?.data.name}</p>
          <p><strong>Email:</strong> {user?.data.email}</p>
          <p><strong>Phone:</strong> {user?.data.phone}</p>
          <p><strong>Website:</strong> {user?.data.website}</p>
        </div>
      </div>
