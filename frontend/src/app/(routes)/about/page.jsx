      ...
      <div className="p-4 w-full">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base text-gray-700 dark:text-gray-300 mb-4">
            Welcome to <span className="font-semibold">BlogSphere</span>, a
            vibrant platform where creativity and community converge. Our
            mission is to empower storytellers, writers, and thinkers to share
            their ideas through a feature-rich blogging experience backed by a
            robust social network.
          </p>
          <p className="text-base text-gray-700 dark:text-gray-300 mb-4">
            BlogSphere offers tools for everyone, from novice bloggers to
            seasoned authors. Create engaging posts with our TipTap rich text
            editor, connect with readers through nested comments and likes, and
            manage your content with ease. Admins ensure quality with powerful
          ...
          <p className="text-base text-gray-700 dark:text-gray-300 mb-4">
            BlogSphere was crafted by Mahdi Moniruzzaman, a passionate developer
            dedicated to building intuitive and scalable web applications.
            Explore the project on{" "}
            <a
              href="https://github.com/mahdimonir/BlogSphere"
