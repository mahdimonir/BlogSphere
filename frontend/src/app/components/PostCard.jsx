      ...
      return (
        <div
          ...
          className={`mt-4 bg-gray-50 dark:bg-gray-900 rounded-lg p-3 border border-gray-200 dark:border-gray-700 ${
            isDeepComment
              ? "ml-0 border-l-4 border-blue-300 dark:border-blue-600"
              : `ml-${depth * 4}`
              ...
              {editingComment === comment._id ? (
                <div className="mt-2 flex items-center gap-2">
                  <textarea
                    ...
                    className="flex-1 p-2 text-sm border rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <button
