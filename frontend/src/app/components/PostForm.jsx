      ...
      >
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className={`mt-1 block w-full p-3 border rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition h-64 ${
          ...
          <Controller
            ...
            render={({ field }) => (
              <TagsInput
                ...
                classNames={{
                  tag: "bg-blue-600 text-white px-2 py-1 rounded-full text-sm mr-1 border border-blue-700",
                  input:
        ...
        <div className="fixed bottom-4 left-0 right-0 max-w-3xl mx-auto bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex justify-end gap-4 z-50 md:p-6 pointer-events-auto">
          ...
          <button
            ...
            className={`px-6 py-2 text-sm bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition pointer-events-auto ${
