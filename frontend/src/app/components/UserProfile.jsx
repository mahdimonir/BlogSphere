    ...
    <div className="mt-4 flex flex-col sm:flex-row gap-4">
      {isOwnProfile ? (
        <>
          <Link
            href="/profile/edit"
            className="w-full sm:w-auto px-4 py-2 bg-blue-500 text-white rounded-full hover:bg-blue-600 text-center"
              ...
              <form onSubmit={handleSubmit(handleRequestOtp)}>
                ...
                <div className="flex justify-between mt-4">
                  <button
                    ...
                    className="px-4 py-2 text-gray-700 dark:text-gray-300 hover:text-blue-500"
                  >
                    Cancel
                  </button>
                  <button
              ...
              {showSortBy && (
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg pl-3 pr-8 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
